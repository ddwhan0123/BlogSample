...
public class FloatWindowSmallView extends LinearLayout {
    ...
    public FloatWindowSmallView(Context context, int msgCount, List<PhoneMessage> phoneMessageArrayList) {
        super(context);
        ...
        percentView.setText("您有" + msgCount + "条短信");
    }
...
//                    openBigWindow();
    ...
    private void openListWindow() {
        MyWindowManager.createListWindow(getContext(), phoneMessageArrayList);
        MyWindowManager.removeSmallWindow(getContext());
    }
